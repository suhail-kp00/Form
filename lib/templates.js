    ...
    body: `
      <div class="dashboard-shell">
        <aside class="dashboard-sidebar">
          ...
          <button class="sidebar-link" data-section="create-bot-form">Create Bot Form</button>
        ...
        <main class="dashboard-content">
          ...
          <section class="dashboard-panel" id="create-bot-form">
            <div class="panel-heading">
              <div>
                <p class="eyebrow">Create bot form</p>
                <h2>Set the form title, add questions, and generate a chat bot link.</h2>
              </div>
              <button class="button button-secondary" id="addQuestionButtonBot" type="button">Add Question</button>
            </div>

            <form id="builderFormBot" class="builder-form">
              <label class="field">
                <span>Bot form title</span>
                <input type="text" id="formTitleBot" name="title" placeholder="Student Details Collection (Chat)" required />
              </label>

              <label class="field">
                <span>Description (Bot intro message)</span>
                <textarea id="formDescriptionBot" name="description" rows="3" placeholder="Tell students or schools what details you need."></textarea>
              </label>

              <div id="questionListBot" class="question-list"></div>

              <div class="builder-actions">
                <p class="status-text" id="builderStatusBot">Add your questions and create the bot form.</p>
                <button class="button button-primary" type="submit">Generate Bot Link</button>
              </div>
            </form>
          </section>
...
export function renderPublicBotPage(site, publicId) {
  return renderLayout({
    title: `${site.businessName} | Chat Bot`,
    pageClass: "public-bot-page",
    body: `
      <main class="public-bot-shell" data-public-form-id="${escapeHtml(publicId)}">
        <header class="public-bot-header">
          <span class="brand-mark">FP</span>
          <div>
            <p class="eyebrow">${escapeHtml(site.businessName)}</p>
        ...
        <section id="publicBotMount" class="public-bot-card">
          <p class="empty-state">Connecting to chat...</p>
        </section>
      </main>
